...
export default function AccountDetail() {
  ...
  const { data: accessKeys, loading: accessKeysLoading } = useAccessKeys(accountId);
  ...
  return (
    <div>
      ...
      <AccountOverview data={overview} loading={overviewLoading} error={overviewError} accountState={accountState} stateLoading={stateLoading} accessKeys={accessKeys} accessKeysLoading={accessKeysLoading} />
